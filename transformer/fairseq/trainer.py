...
class Trainer(object):
    ...
    def __init__(self, args, task, model, criterion, dummy_batch):
        ...
        if args.fp16:
            ...
            if not args.dist_avg in ['gossip', 'simple_gossip', 'allreduce2']:
    ...
    def train_step(self, samples, dummy_batch=False):
        ...
        #if self.args.dist_avg == 'gossip':
        #    self.model.communicator_warmup()
        self.model.train()
        self.zero_grad()
        ...
        if dummy_batch or local_sample_size == 0:
            print('| WARNING: local_sample_size', local_sample_size)
            return None
        ...
        if ooms == 1:
            print('| WARNING: OOM, skipping update')
            self.zero_grad()
            return None
        ...
        try:
            ...
            self.optimizer.multiply_grads(1. / float(local_sample_size))
            ...
            self.optimizer.step()
            self._num_updates += 1
            if self.args.dist_avg in ['simple_gossip', 'gossip', 'allreduce2']:
