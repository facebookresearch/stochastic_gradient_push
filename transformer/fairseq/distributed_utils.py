...
def distributed_init(args):
    print (args.dist_avg, args.distributed_backend,args.distributed_init_method, args.distributed_world_size, args.distributed_rank)
    ...
    print('| distributed init ({} rank {} device_id {}): {}'.format(
        socket.gethostname(), args.distributed_rank, args.device_id, args.distributed_init_method), flush=True)
