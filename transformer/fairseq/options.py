...
def add_distributed_training_args(parser):
    ...
    group.add_argument('--fix-batches-to-gpus', action='store_true',
                       help='Don\'t shuffle batches between GPUs, this reduces overall '
                            ...
                            're-reading the data')
    parser.add_argument('--dist_avg', default='allreduce', type=str,
                        help='type of averaging for the distributed optimizers ')
    parser.add_argument('--dist_process', default=0, type=int,
                        help='Use only one gpu per process ')
